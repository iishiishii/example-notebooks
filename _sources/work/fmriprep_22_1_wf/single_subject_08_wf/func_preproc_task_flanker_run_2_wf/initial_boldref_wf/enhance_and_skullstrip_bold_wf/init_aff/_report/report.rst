Node: single_subject_08_wf (func_preproc_task_flanker_run_2_wf (initial_boldref_wf (enhance_and_skullstrip_bold_wf (init_aff (ants)
===================================================================================================================================


 Hierarchy : fmriprep_22_1_wf.single_subject_08_wf.func_preproc_task_flanker_run_2_wf.initial_boldref_wf.enhance_and_skullstrip_bold_wf.init_aff
 Exec ID : init_aff
...
* output_transform : /home/runner/work/example-notebooks/example-notebooks/books/functional_imaging/work/fmriprep_22_1_wf/single_subject_08_wf/func_preproc_task_flanker_run_2_wf/initial_boldref_wf/enhance_and_skullstrip_bold_wf/init_aff/initialization.mat
...
* cmdline : antsAI -c [10,1e-06,10] -d 3 -x /home/fmriprep/.cache/templateflow/tpl-MNI152NLin2009cAsym/tpl-MNI152NLin2009cAsym_res-02_desc-brain_mask.nii.gz -m Mattes[/home/fmriprep/.cache/templateflow/tpl-MNI152NLin2009cAsym/tpl-MNI152NLin2009cAsym_res-02_desc-fMRIPrep_boldref.nii.gz,/home/runner/work/example-notebooks/example-notebooks/books/functional_imaging/work/fmriprep_22_1_wf/single_subject_08_wf/func_preproc_task_flanker_run_2_wf/initial_boldref_wf/gen_avg/sub-08_task-flanker_run-2_bold_average.nii.gz,32,Regular,0.2] -o initialization.mat -p 0 -s [20,0.12] -g [40.0,0x40x40] -t Affine[0.1] -v 1
* duration : 253.978757
* hostname : fv-az621-157
* prev_wd : /home/runner/work/example-notebooks/example-notebooks/books/functional_imaging
* working_dir : /home/runner/work/example-notebooks/example-notebooks/books/functional_imaging/work/fmriprep_22_1_wf/single_subject_08_wf/func_preproc_task_flanker_run_2_wf/initial_boldref_wf/enhance_and_skullstrip_bold_wf/init_aff
...
MultiStartOptimizerv4Template (0x2063ab0): An exception occurred in sub-optimization number 19.  If too many of these occur, you may need to set a different set of initial parameters.

WARNING: In /src/ants/build/staging/include/ITK-5.1/itkMultiStartOptimizerv4.hxx, line 186
MultiStartOptimizerv4Template (0x2063ab0): An exception occurred in sub-optimization number 29.  If too many of these occur, you may need to set a different set of initial parameters.

WARNING: In /src/ants/build/staging/include/ITK-5.1/itkMultiStartOptimizerv4.hxx, line 186
MultiStartOptimizerv4Template (0x2063ab0): An exception occurred in sub-optimization number 86.  If too many of these occur, you may need to set a different set of initial parameters.

WARNING: In /src/ants/build/staging/include/ITK-5.1/itkMultiStartOptimizerv4.hxx, line 186
MultiStartOptimizerv4Template (0x2063ab0): An exception occurred in sub-optimization number 87.  If too many of these occur, you may need to set a different set of initial parameters.

WARNING: In /src/ants/build/staging/include/ITK-5.1/itkMultiStartOptimizerv4.hxx, line 186
MultiStartOptimizerv4Template (0x2063ab0): An exception occurred in sub-optimization number 92.  If too many of these occur, you may need to set a different set of initial parameters.

WARNING: In /src/ants/build/staging/include/ITK-5.1/itkMultiStartOptimizerv4.hxx, line 186
MultiStartOptimizerv4Template (0x2063ab0): An exception occurred in sub-optimization number 137.  If too many of these occur, you may need to set a different set of initial parameters.

WARNING: In /src/ants/build/staging/include/ITK-5.1/itkMultiStartOptimizerv4.hxx, line 186
MultiStartOptimizerv4Template (0x2063ab0): An exception occurred in sub-optimization number 146.  If too many of these occur, you may need to set a different set of initial parameters.

WARNING: In /src/ants/build/staging/include/ITK-5.1/itkMultiStartOptimizerv4.hxx, line 186
MultiStartOptimizerv4Template (0x2063ab0): An exception occurred in sub-optimization number 158.  If too many of these occur, you may need to set a different set of initial parameters.
