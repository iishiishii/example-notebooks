...
MultiStartOptimizerv4Template (0x383e6b0): An exception occurred in sub-optimization number 9.  If too many of these occur, you may need to set a different set of initial parameters.

WARNING: In /src/ants/build/staging/include/ITK-5.1/itkMultiStartOptimizerv4.hxx, line 186
MultiStartOptimizerv4Template (0x383e6b0): An exception occurred in sub-optimization number 25.  If too many of these occur, you may need to set a different set of initial parameters.
