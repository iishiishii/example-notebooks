Node: sub-2 (ses-1 (run-01 (func_read-json-se (utility)
=======================================================


 Hierarchy : workflow_qsm.sub-2.ses-1.run-01.func_read-json-se
 Exec ID : func_read-json-se
...
* function_str : def read_json_se(params_files):
    import json
...
* params_files : ['/home/runner/work/example-notebooks/example-notebooks/books/structural_imaging/bids/sub-2/ses-1/anat/sub-2_ses-1_run-01_part-phase_T2starw.json']
...
* working_dir : /home/runner/work/example-notebooks/example-notebooks/books/structural_imaging/qsm/workflow_qsm/sub-2/ses-1/run-01/func_read-json-se
